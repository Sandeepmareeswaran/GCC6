  ...
  return (
    <section className={styles.hero}>
      <div className={styles.content}>
        <div className={styles.eyebrow}>{t('New')} · {t('Integrations')}</div>
        <h1 className={styles.title}>
          {t('Discover powerful integrations that accelerate your workflows')}
        </h1>
        <p className={styles.subtitle}>
          {t('Connect your favorite tools in minutes, automate repetitive tasks, and deliver seamless experiences for your team and customers.')}
        </p>
      </div>
      ...
      <div className={styles.visual}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', width: '100%', height: '100%' }}>
          ...
          <span className={styles.visualPlaceholder}>{t('Integration Preview')}</span>
        </div>
      </div>
    </section>
  );
